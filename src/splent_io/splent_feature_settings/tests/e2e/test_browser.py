"""
End-to-end tests for splent_feature_settings.
...
Run with:  splent feature:test splent_feature_settings --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_settings")
    assert "splent_feature_settings" in browser.page_source.lower()
