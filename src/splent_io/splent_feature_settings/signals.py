"""
Signals for splent_feature_settings.
...
Examples::
    ...
    item_created = define_signal("item-created", "splent_feature_settings")

    # Connect to a signal from another feature:
    from splent_framework.signals.signal_utils import connect_signal

    @connect_signal("user-registered", "splent_feature_settings")
